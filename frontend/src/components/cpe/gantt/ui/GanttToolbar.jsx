                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1 bg-gray-50 px-2 py-1.5 rounded-lg border border-gray-200 shadow-sm">
                                <button
                                    ...
                                    className={`px-2.5 py-1 text-xs rounded-md transition-all font-semibold ${viewMode === "category"
                                ...
                                <button
                                    type="button"
                                    onClick={() => onChangeViewMode("process")}
                                    className={`px-2.5 py-1 text-xs rounded-md transition-all font-semibold ${viewMode === "process"
                                        ? "bg-white text-blue-600 shadow-sm ring-1 ring-gray-100"
                                        : "text-gray-500 hover:text-gray-900"
                                        }`}
                                >
                                ...
                                <button
                                    type="button"
                                    onClick={() => onChangeViewMode("work_type")}
                                    className={`px-2.5 py-1 text-xs rounded-md transition-all font-semibold ${viewMode === "work_type"
                                        ? "bg-white text-blue-600 shadow-sm ring-1 ring-gray-100"
                                        : "text-gray-500 hover:text-gray-900"
                                        }`}
                                >
