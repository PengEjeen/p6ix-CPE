 ...
 *   apartment/view_result     → 갑지 확인 탭/페이지 (mount)
 */
    ...
    TOTAL: [
        {
            id: "create_project",
            title: "전체 공기산정 갑지 생성",
            desc: "전체 공기산정 갑지를 처음 만들어봅니다.",
            howTo: "홈 > + 새 갑지 > 전체 공기산정 선택 > 생성",
            actionLabel: "생성",
        },
        {
            ...
            howTo: "갑지 진입 > 상단 탭 > 가동률",
            actionLabel: "이동",
        },
        {
            id: "edit_schedule",
            title: "공정표 수정해보기",
            desc: "공정표 화면에서 공종·기간을 입력하거나 수정합니다.",
            howTo: "갑지 진입 > 상단 탭 > 공정표",
            actionLabel: "이동",
        },
        {
            id: "adjust_gantt",
    ...
    APARTMENT: [
        {
            id: "create_project",
            title: "공기계산 갑지 생성",
            desc: "공기계산 갑지를 처음 만들어봅니다.",
            howTo: "홈 > + 새 갑지 > 공기 계산 선택 > 생성",
            actionLabel: "생성",
        },
        {
            id: "view_standards",
        ...
        },
        {
            id: "adjust_input",
            title: "공기산정 입력 조정해보기",
            desc: "각 공종별 투입 조건과 수치를 입력·조정합니다.",
            howTo: "갑지 진입 > 탭 > 공기산정 입력",
            actionLabel: "이동",
        },
        {
            id: "view_result",
